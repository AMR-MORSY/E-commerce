{{-- <div class="max-w-7xl mt-11 mx-auto py-6 px-4">
    <!-- Header -->
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
                ...
                <input type="text" wire:model.live.debounce.300ms="search"
                    placeholder="Search by name, SKU, or description..." class="w-full border rounded px-3 py-2">
            </div>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse($products as $product)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span
                                    class="text-sm font-medium {{ $product->total_stock > 0 ? 'text-green-600' : 'text-red-600' }}">
    ...
    <div class="bg-white rounded-lg shadow-md p-4 mb-6">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div>
                ...
                <select wire:model.live="typeFilter" class="w-full border rounded px-3 py-2">
